...
sysinit_app(void)
{
    ...
    /*** Stage 415 */
    /* 415.0: rtdoa_tag_pkg_init (lib/rtdoa_tag) */
    rtdoa_tag_pkg_init();
    ...
    imgmgr_module_init();
    /* 500.3: nmgr_pkg_init (mgmt/newtmgr) */
    nmgr_pkg_init();
    /* 500.4: shell_init (sys/shell) */
    shell_init();
    /* 500.5: split_app_init (boot/split) */
    split_app_init();
    /* 500.6: uwbcfg_pkg_init (sys/uwbcfg) */
    uwbcfg_pkg_init();
    ...
    /*** Stage 600 */
    /* 600.0: rtdoa_backhaul_pkg_init (lib/rtdoa_backhaul) */
